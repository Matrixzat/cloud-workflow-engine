// Dex2C_impl.cpp — codehasan/dex2c project/jni/nc/Dex2C.cpp verbatim.
// Adaptation: JNI_OnLoad replaced with D2C_HAS_JNILOAD guard for our build.
// amimo/dcc/DccApplication JNI methods removed (not our app class).
#include "Dex2C.h"
