...
public class PythonDownloadService extends Service {
    ...
    public static final String ACTION_START  = "com.dex2c.mega.python.START";
    public static final String ACTION_CANCEL = "com.dex2c.mega.python.CANCEL";

    public static final String BROADCAST   = "com.dex2c.mega.python.PROGRESS";
    ...
    private Notification buildNotification(String text, int pct) {
        Intent open = new Intent(this, com.dex2c.mega.ui.CompilerSetupActivity.class);
